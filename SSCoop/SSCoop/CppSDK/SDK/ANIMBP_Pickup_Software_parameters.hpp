...
static_assert(offsetof(ANIMBP_Pickup_Software_C_AnimGraph, Param_AnimGraph) == 0x000000, "Member 'ANIMBP_Pickup_Software_C_AnimGraph::Param_AnimGraph' has a wrong offset!");
