...
// ENUM_UpgradeResult                      Param_UpgradeResult                                    (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UWIDGET_PlayerHUD_C::EVENT_OnItemUpgraded(class UClass* UpgradeClass, class UClass* DowngradeClass, ENUM_UpgradeResult Param_UpgradeResult)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_UpgradeResult = Param_UpgradeResult;
...
// (Public, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
// class UUserWidget*                      Param_ToolTipWidget                                    (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UWIDGET_PlayerHUD_C::RequestToolTipUpdate(class UUserWidget* Param_ToolTipWidget)
{
	static class UFunction* Func = nullptr;
...
void UWIDGET_PlayerHUD_C::GetSlotIndexFromNumber(int32 SlotNumber, int32* Param_Index)
{
	static class UFunction* Func = nullptr;
...
// ENUM_MFDTabCategory                     Param_CurrentMFDTab                                    (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UWIDGET_PlayerHUD_C::GetMFDState(bool* IsMFDOpen, ENUM_MFDTabCategory* Param_CurrentMFDTab)
{
	static class UFunction* Func = nullptr;
	...
	if (Param_CurrentMFDTab != nullptr)
		*Param_CurrentMFDTab = Parms.Param_CurrentMFDTab;
}
