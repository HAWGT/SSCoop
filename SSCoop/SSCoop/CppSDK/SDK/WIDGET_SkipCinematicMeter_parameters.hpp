...
{
public:
	float                                         Param_HoldLength;                                  // 0x0000(0x0004)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(WIDGET_SkipCinematicMeter_C_BeginSkipCounter, Param_HoldLength) == 0x000000, "Member 'WIDGET_SkipCinematicMeter_C_BeginSkipCounter::Param_HoldLength' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_27FD[0x2];                                     // 0x000A(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_27FE[0x3];                                     // 0x0019(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
