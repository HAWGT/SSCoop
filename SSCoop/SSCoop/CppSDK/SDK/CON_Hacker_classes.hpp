...
public:
	...
	uint8                                         Pad_2FAD[0x7];                                     // 0x05E1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2FAE[0x7];                                     // 0x05F9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2FAF[0x4];                                     // 0x0644(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2FB0[0x6];                                     // 0x0662(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	void OnUsingGamepadChanged__DelegateSignature(bool Param_IsUsingGamepad);
	...
	void TeleportToElevatorByIndex(int32 Param_Index);
	void TeleportToTerminalByIndex(int32 Param_Index);
	...
	void CreateCyberRiftMaterialForCamera(class UCameraComponent* Param_Camera, bool HasEntered);
	void DestroyCyberRiftMaterialForCamera(class UCameraComponent* Param_Camera);
