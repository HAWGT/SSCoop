...
// Parameters:
// int32                                   Param_LowHideMask                                      (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// int32                                   Param_HighHideMask                                     (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// class FName                             Param_LimbRowName                                      (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UCOMP_DismembermentManager_C::InitializeDismemberedLimb(int32 Param_LowHideMask, int32 Param_HighHideMask, class UDataTable* DismembermentData, class UDataTable* DynaDamageData, class FName Param_LimbRowName, int32 MissingLimbBits, int32 ActivatedDynaDamageBits, TArray<struct FVector4>& BloodData)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_LowHideMask = Param_LowHideMask;
	Parms.Param_HighHideMask = Param_HighHideMask;
	Parms.DismembermentData = DismembermentData;
	Parms.DynaDamageData = DynaDamageData;
	Parms.Param_LimbRowName = Param_LimbRowName;
...
// class UOBJ_ImpactData_C*                Impact                                                 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// struct FAttribDamageInstance            Damage                                                 (BlueprintVisible, BlueprintReadOnly, Parm)
// bool                                    Param_DestroyLimb                                      (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
// bool                                    LegDismembered                                         (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor)

void UCOMP_DismembermentManager_C::ForceDismemberLimb(class FName LimbToDismember, class UOBJ_ImpactData_C* Impact, const struct FAttribDamageInstance& Damage, bool Param_DestroyLimb, bool* LegDismembered)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Impact = Impact;
	Parms.Damage = std::move(Damage);
	Parms.Param_DestroyLimb = Param_DestroyLimb;
...
void UCOMP_DismembermentManager_C::GetLimbByIndex(int32 Param_Index, class FName* LimbName)
{
	static class UFunction* Func = nullptr;
...
void UCOMP_DismembermentManager_C::GetLimbIndex(class FName LimbName, int32* Param_Index)
{
	static class UFunction* Func = nullptr;
...
void UCOMP_DismembermentManager_C::GetDynaIndex(class FName DynaElement, int32* Param_Index)
{
	static class UFunction* Func = nullptr;
...
void UCOMP_DismembermentManager_C::GetDynaDamageByIndex(int32 Param_Index, class FName* DynaName)
{
	static class UFunction* Func = nullptr;
