...
public:
	...
	uint8                                         Pad_273A[0x2];                                     // 0x0292(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_273B[0x4];                                     // 0x029C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_273C[0x4];                                     // 0x02C4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_273D[0x4];                                     // 0x02E4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	void GetSliderValueFromMousePosition(float* Param_SliderValue);
	void GetSliderValue(float* NormalizedValue);
	void GetRealValue(float* RealValue);
	void GetSliderPositionFromValue(float Param_SliderValue, struct FVector2D* NewParam);
	void RealToNormalized(float RealValue, float* NormalizedValue);
	void Set_Instanced_Values(int32 Param_DiscreteValues, float InitialValues, float Param_ValueMin, float Param_ValueMax, const class FText& Param_Postfix, int32 Param_FractionalDigits);
	...
	void NormalizedToReal(float Param_SliderValue, float* RealValue) const;
