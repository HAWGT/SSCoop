...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// bool                                    Param_TutorialsOverridden                              (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)

void UWIDGET_TutorialMessage_C::SetTutorialsOverridden(bool Param_TutorialsOverridden)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_TutorialsOverridden = Param_TutorialsOverridden;
