...
public:
	...
	uint8                                         Pad_2B1B[0x2];                                     // 0x0392(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	void OnCargoSpawned__DelegateSignature(class AINTERACT_LogisticsLift_C* LogisticsLift, class AActor* Param_CargoActor);
	void OnCargoDelivered__DelegateSignature(class AINTERACT_LogisticsLift_C* LogisticsLift, class AActor* Param_CargoActor);
	...
	void SetCargoClassOverride(class UClass* Param_Class);
