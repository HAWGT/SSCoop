...
void UOPTION_Display_WindowMode_C::IsDirty(bool* Param_IsDirty)
{
	static class UFunction* Func = nullptr;
...
void UOPTION_Display_WindowMode_C::InitializeMenuListItem(class UWIDGET_MenuListBase_C* ParentList, int32 Param_Index)
{
	static class UFunction* Func = nullptr;
