...
public:
	...
	uint8                                         Pad_27EA[0x2];                                     // 0x001A(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_27EB[0x4];                                     // 0x001C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_27EC[0x3];                                     // 0x0015(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(AnimBP_SecurityCamera_C_AnimGraph, Param_AnimGraph) == 0x000000, "Member 'AnimBP_SecurityCamera_C_AnimGraph::Param_AnimGraph' has a wrong offset!");
