...
// Parameters:
// class UPrimitiveComponent*              CursorPrimitive                                        (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class FName                             Param_TargetLevel                                      (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void AELEVATOR_Base_C::GetTargetLevelName(class UPrimitiveComponent* CursorPrimitive, class FName* Param_TargetLevel)
{
	static class UFunction* Func = nullptr;
	...
	if (Param_TargetLevel != nullptr)
		*Param_TargetLevel = Parms.Param_TargetLevel;
}
...
// class FName                             Param_TargetLevel                                      (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// ENUM_UpDown                             DirectionToTarget                                      (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void AELEVATOR_Base_C::GetDirectionToTargetLevelFromSource(class FName SourceLevel, class FName Param_TargetLevel, ENUM_UpDown* DirectionToTarget)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_TargetLevel = Param_TargetLevel;
...
void AELEVATOR_Base_C::GetTargetLevel(class FName* Param_TargetLevel)
{
	static class UFunction* Func = nullptr;
...
void AELEVATOR_Base_C::GetMoveDirectionVector(class FName Param_TargetLevel, struct FVector* Direction)
{
	static class UFunction* Func = nullptr;
