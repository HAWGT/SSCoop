...
public:
	...
	uint8                                         Pad_345B[0x5];                                     // 0x034B(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	void InitilalizeSubtitleWidget(class UWIDGET_MediaDisplay_C* Param_MediaDisplay, TScriptInterface<class IINTERF_HUD_C> Player_HUD);
	void ClearSubtitles();
