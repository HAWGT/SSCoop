...
void UFUNCLIB_UserInterface_C::GetKeyboardButtonAtlasIndex(const struct FKey& Key, class UObject* __WorldContext, int32* Param_Index)
{
	static class UFunction* Func = nullptr;
...
void UFUNCLIB_UserInterface_C::GetMouseButtonAtlasIndex(const struct FKey& Key, class UObject* __WorldContext, int32* Param_Index)
{
	static class UFunction* Func = nullptr;
...
void UFUNCLIB_UserInterface_C::GetGamepadButtonAtlasIndex(const struct FKey& Key, class UObject* __WorldContext, int32* Param_Index, float* Rotation)
{
	static class UFunction* Func = nullptr;
