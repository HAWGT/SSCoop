...
public:
	...
	uint8                                         Pad_386B[0x3];                                     // 0x022D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_386C[0x6];                                     // 0x0252(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_386D[0x4];                                     // 0x02FC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	void GetModeCount(int32* Param_Count);
	void GetCurrentMode(struct FSTRUCT_WeaponMode* Mode);
	void GetWeaponModeDefaults(int32 Param_Index, struct FSTRUCT_WeaponMode* Mode);
	void GetWeaponMode(int32 Param_Index, struct FSTRUCT_WeaponMode* Mode);
	...
	void InitializeItem(class UInventoryBag_C* Param_Bag);
