...
public:
	...
	class UWIDGET_PageTab_C*                      Param_PageTab;                                     // 0x0008(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(offsetof(WIDGET_UnreadMediaIcon_C_InitializeUnreadMediaIcon, Param_PlayerHUD) == 0x000000, "Member 'WIDGET_UnreadMediaIcon_C_InitializeUnreadMediaIcon::Param_PlayerHUD' has a wrong offset!");
static_assert(offsetof(WIDGET_UnreadMediaIcon_C_InitializeUnreadMediaIcon, Param_PageTab) == 0x000008, "Member 'WIDGET_UnreadMediaIcon_C_InitializeUnreadMediaIcon::Param_PageTab' has a wrong offset!");
...
{
public:
	bool                                          Param_IsUnreadMessage;                             // 0x0000(0x0001)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
};
...
static_assert(offsetof(WIDGET_UnreadMediaIcon_C_SetIsUnreadMessage, Param_IsUnreadMessage) == 0x000000, "Member 'WIDGET_UnreadMediaIcon_C_SetIsUnreadMessage::Param_IsUnreadMessage' has a wrong offset!");
