...
int32 USkinnedDecalSampler::SpawnDecal(const struct FVector& WorldLocation, const struct FQuat& WorldRotation, class FName BoneName, float Size, int32 SubUV, int32 Param_Index)
{
	static class UFunction* Func = nullptr;
