...
// ENUM_SaveLoad                           Param_Mode                                             (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// int32                                   Param_UserIndex                                        (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UWIDGET_SaveLoadMenu_C::SetSaveLoadMenuVisibility(bool NewVisibility, ENUM_SaveLoad Param_Mode, int32 Param_UserIndex)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_UserIndex = Param_UserIndex;
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// class UWidget*                          Param_MainMenu                                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UWIDGET_SaveLoadMenu_C::SetMainMenu(class UWidget* Param_MainMenu)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_MainMenu = Param_MainMenu;
...
void UWIDGET_SaveLoadMenu_C::SetSelectedItem(int32 Param_Index)
{
	static class UFunction* Func = nullptr;
...
// int32                                   Param_UserIndex                                        (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                                    bSuccess                                               (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)

void UWIDGET_SaveLoadMenu_C::EVENT_OnGameSessionSaved(const class FString& SaveName, const int32 Param_UserIndex, bool bSuccess)
{
	static class UFunction* Func = nullptr;
