...
public:
	...
	uint8                                         Pad_332C[0x5];                                     // 0x001B(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_332D[0x7];                                     // 0x0039(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	bool                                          Param_EnableExtraText;                             // 0x0000(0x0001)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
...
static_assert(offsetof(WIDGET_SubMenu_Header_C_ToggleExtraText, Param_EnableExtraText) == 0x000000, "Member 'WIDGET_SubMenu_Header_C_ToggleExtraText::Param_EnableExtraText' has a wrong offset!");
