...
{
public:
	class FName                                   Name_BP_MusicLayer_C;                              // 0x0028(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)
	...
	uint8                                         Pad_1F89[0x2];                                     // 0x004E(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UBP_MusicLayer_C, Name_BP_MusicLayer_C) == 0x000028, "Member 'UBP_MusicLayer_C::Name_BP_MusicLayer_C' has a wrong offset!");
