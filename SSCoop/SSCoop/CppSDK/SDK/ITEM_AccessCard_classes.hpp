...
class UITEM_AccessCard_C final : public UITEM_UpgradeBase_C
{
public:
...
public:
	...
	void GetDisplayProperties(class USkeletalMesh** SkeletalMesh, class UClass** Param_AnimInstanceClass, class UMaterialInterface** OverrideMaterial);
