...
void UITEM_WeaponBase_C::GetModeCount(int32* Param_Count)
{
	static class UFunction* Func = nullptr;
...
void UITEM_WeaponBase_C::GetWeaponModeDefaults(int32 Param_Index, struct FSTRUCT_WeaponMode* Mode)
{
	static class UFunction* Func = nullptr;
...
void UITEM_WeaponBase_C::GetWeaponMode(int32 Param_Index, struct FSTRUCT_WeaponMode* Mode)
{
	static class UFunction* Func = nullptr;
...
void UITEM_WeaponBase_C::InitializeItem(class UInventoryBag_C* Param_Bag)
{
	static class UFunction* Func = nullptr;
