...
// (Public, HasOutParams, BlueprintCallable, BlueprintEvent, BlueprintPure)
// Parameters:
// ENUM_TargetType                         Param_BodyRotationType                                 (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UCOMP_EnemyMovement_C::GetBodyRotationTargetType(ENUM_TargetType* Param_BodyRotationType)
{
	static class UFunction* Func = nullptr;
	...
	if (Param_BodyRotationType != nullptr)
		*Param_BodyRotationType = Parms.Param_BodyRotationType;
}
...
// (Public, HasOutParams, BlueprintCallable, BlueprintEvent, BlueprintPure)
// Parameters:
// float                                   Param_BodyRotateSpeed                                  (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UCOMP_EnemyMovement_C::GetBodyRotateSpeedValueByType(float* Param_BodyRotateSpeed)
{
	static class UFunction* Func = nullptr;
	...
	if (Param_BodyRotateSpeed != nullptr)
		*Param_BodyRotateSpeed = Parms.Param_BodyRotateSpeed;
}
...
// Parameters:
// class APAWN_Enemy_C*                    Param_Pawn                                             (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UCOMP_EnemyMovement_C::GetPawn(class APAWN_Enemy_C** Param_Pawn)
{
	static class UFunction* Func = nullptr;
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// bool                                    Param_ForceUpdatePath                                  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)

void UCOMP_EnemyMovement_C::SetForceUpdatePath(bool Param_ForceUpdatePath)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_ForceUpdatePath = Param_ForceUpdatePath;
