...
// (Public, HasOutParams, BlueprintCallable, BlueprintEvent, BlueprintPure)
// Parameters:
// class UCharacterAction_C*               Param_CurrentAction                                    (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UCOMP_ActionManager_C::GetCurrentAction(class UCharacterAction_C** Param_CurrentAction)
{
	static class UFunction* Func = nullptr;
	...
	if (Param_CurrentAction != nullptr)
		*Param_CurrentAction = Parms.Param_CurrentAction;
}
