...
public:
	...
	uint8                                         Pad_2067[0x5];                                     // 0x029B(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	void SetTexture();
	void GetDynamicMaterial(class UMaterialInstanceDynamic** Param_DynamicMaterial);
	void InitializeWaypointElement(class UWIDGET_Automap_Waypoints_C* Param_WaypointWidget);
