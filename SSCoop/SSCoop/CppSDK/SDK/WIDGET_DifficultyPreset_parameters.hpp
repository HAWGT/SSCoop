...
static_assert(offsetof(WIDGET_DifficultyPreset_C_SetHighlighted, Param_Highlighted) == 0x000000, "Member 'WIDGET_DifficultyPreset_C_SetHighlighted::Param_Highlighted' has a wrong offset!");
