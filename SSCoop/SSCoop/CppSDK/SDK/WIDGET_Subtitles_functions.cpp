...
// Parameters:
// class UWIDGET_MediaDisplay_C*           Param_MediaDisplay                                     (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UWIDGET_Subtitles_C::InitilalizeSubtitleWidget(class UWIDGET_MediaDisplay_C* Param_MediaDisplay, TScriptInterface<class IINTERF_HUD_C> Player_HUD)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_MediaDisplay = Param_MediaDisplay;
