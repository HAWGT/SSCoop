...
public:
	...
	static TArray<class UClass*> GetBlueprintClasses(class UClass* BaseClass, const class FString& Param_Name, const class FString& Folder);
	...
	static int64 GetEnumValueByName(class UEnum* Enum, class FName Param_Name);
	...
	static class UClass* GetSuperClass(class UClass* Param_Class);
...
public:
	...
	uint8                                         Pad_1875[0x3E];                                    // 0x0052(0x003E)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_1876[0x18];                                    // 0x0028(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_1879[0x164];                                   // 0x0034(0x0164)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_1889[0x3];                                     // 0x003D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_188B[0x3];                                     // 0x0029(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_188C[0x3];                                     // 0x0035(0x0003)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	void SetSmoothingFactor(float Param_Smoothing);
...
{
public:
	uint8                                         Pad_188D[0x10];                                    // 0x0038(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_188E[0x10];                                    // 0x0038(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_188F[0x10];                                    // 0x0038(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
