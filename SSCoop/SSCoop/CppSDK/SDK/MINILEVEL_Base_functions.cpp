...
// Parameters:
// class ACON_Hacker_C*                    Param_PlayerController                                 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// class USceneCaptureComponent2D*         Param_SceneCaptureComponent                            (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                                    Result                                                 (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor)

void AMINILEVEL_Base_C::InitializeMinigame(class ACON_Hacker_C* Param_PlayerController, class APAWN_Hacker_Simple_C* PlayerPawn, class USceneCaptureComponent2D* Param_SceneCaptureComponent, bool* Result)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_SceneCaptureComponent = Param_SceneCaptureComponent;
...
// class APAWN_Hacker_Simple_C*            Param_HackerPawn                                       (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void AMINILEVEL_Base_C::PossessMinigamePawn(class APawn* TargetPawn, class APAWN_Hacker_Simple_C* Param_HackerPawn, class ACON_Hacker_C* Controller, bool* Result)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_HackerPawn = Param_HackerPawn;
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// class APlayerController*                Param_PlayerController                                 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void AMINILEVEL_Base_C::OnGamePaused(class APlayerController* Param_PlayerController)
{
	static class UFunction* Func = nullptr;
