...
static_assert(offsetof(WIDGET_DifficultyHexagonButton_C_OnSelectNewDifficulty__DelegateSignature, Param_IndexInList) == 0x000000, "Member 'WIDGET_DifficultyHexagonButton_C_OnSelectNewDifficulty__DelegateSignature::Param_IndexInList' has a wrong offset!");
...
static_assert(offsetof(WIDGET_DifficultyHexagonButton_C_SetSelected, Param_Selected) == 0x000000, "Member 'WIDGET_DifficultyHexagonButton_C_SetSelected::Param_Selected' has a wrong offset!");
...
static_assert(offsetof(WIDGET_DifficultyHexagonButton_C_SetHighlighted, Param_Highlighted) == 0x000000, "Member 'WIDGET_DifficultyHexagonButton_C_SetHighlighted::Param_Highlighted' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_2E9A[0x4];                                     // 0x0024(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	bool                                          Param_Disabled;                                    // 0x0000(0x0001)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
};
...
static_assert(offsetof(WIDGET_DifficultyHexagonButton_C_SetDisabled, Param_Disabled) == 0x000000, "Member 'WIDGET_DifficultyHexagonButton_C_SetDisabled::Param_Disabled' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_2E9B[0x4];                                     // 0x0054(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(WIDGET_DifficultyHexagonButton_C_SetHovered, Param_Hovered) == 0x000000, "Member 'WIDGET_DifficultyHexagonButton_C_SetHovered::Param_Hovered' has a wrong offset!");
