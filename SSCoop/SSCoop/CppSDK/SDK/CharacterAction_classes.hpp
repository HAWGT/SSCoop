...
public:
	...
	uint8                                         Pad_22A5[0x7];                                     // 0x0041(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	void PlayMontage(float PlayRate, float* Param_MontageDuration);
	void ResumeMontage(float PlayRate, float* Param_MontageDuration);
	void StopMontage(float BlendOutTime);
	void SetMontageWithPriority(class UAnimMontage* Param_Montage, ENUM_ActionPriority Param_Priority);
