...
{
public:
	class ACON_Hacker_C*                          Param_PlayerController;                            // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class USceneCaptureComponent2D*               Param_SceneCaptureComponent;                       // 0x0010(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(MINILEVEL_Base_C_InitializeMinigame, Param_PlayerController) == 0x000000, "Member 'MINILEVEL_Base_C_InitializeMinigame::Param_PlayerController' has a wrong offset!");
...
static_assert(offsetof(MINILEVEL_Base_C_InitializeMinigame, Param_SceneCaptureComponent) == 0x000010, "Member 'MINILEVEL_Base_C_InitializeMinigame::Param_SceneCaptureComponent' has a wrong offset!");
...
public:
	...
	class APAWN_Hacker_Simple_C*                  Param_HackerPawn;                                  // 0x0008(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(MINILEVEL_Base_C_PossessMinigamePawn, Param_HackerPawn) == 0x000008, "Member 'MINILEVEL_Base_C_PossessMinigamePawn::Param_HackerPawn' has a wrong offset!");
...
{
public:
	class APlayerController*                      Param_PlayerController;                            // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(MINILEVEL_Base_C_OnGamePaused, Param_PlayerController) == 0x000000, "Member 'MINILEVEL_Base_C_OnGamePaused::Param_PlayerController' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_1DFA[0x7];                                     // 0x0021(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
