...
public:
	...
	uint8                                         Pad_3029[0x6];                                     // 0x0312(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	void IsDirty(bool* Param_IsDirty);
	void SaveNewValue();
	...
	void InitializeMenuListItem(class UWIDGET_MenuListBase_C* ParentList, int32 Param_Index);
