...
public:
	...
	uint8                                         Pad_2848[0x2];                                     // 0x032A(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	void SetChargeState(uint8 Count, int32 Param_MagneticDamage, int32 Param_ElectricDamage, bool Param_IsUpgraded);
