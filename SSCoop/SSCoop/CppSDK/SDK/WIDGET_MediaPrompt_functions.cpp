...
void UWIDGET_MediaPrompt_C::InitializeMediaPrompt(class UWIDGET_PlayerHUD_C* Param_PlayerHUD)
{
	static class UFunction* Func = nullptr;
...
void UWIDGET_MediaPrompt_C::GetMediaPriority(class UITEM_MediaBase_C* MediaItem, int32* Param_Priority)
{
	static class UFunction* Func = nullptr;
