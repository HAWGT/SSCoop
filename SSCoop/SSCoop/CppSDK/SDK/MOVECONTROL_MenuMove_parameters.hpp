...
static_assert(offsetof(MOVECONTROL_MenuMove_C_InitializeMoveControl, Param_Player) == 0x000000, "Member 'MOVECONTROL_MenuMove_C_InitializeMoveControl::Param_Player' has a wrong offset!");
