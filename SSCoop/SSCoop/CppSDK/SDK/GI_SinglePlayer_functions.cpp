...
// Parameters:
// TArray<class FName>                     Param_VisitedLevels                                    (Parm, OutParm)

void UGI_SinglePlayer_C::GetVisitedLevels(TArray<class FName>* Param_VisitedLevels)
{
	static class UFunction* Func = nullptr;
	...
	if (Param_VisitedLevels != nullptr)
		*Param_VisitedLevels = std::move(Parms.Param_VisitedLevels);
}
...
void UGI_SinglePlayer_C::GetVisitedLevelIndex(class FName LevelName, int32* Param_Index)
{
	static class UFunction* Func = nullptr;
...
// TSoftClassPtr<class UClass>             Param_Class                                            (Parm, OutParm, HasGetValueTypeHash)
// struct FSTRUCT_EnemyReinforcementSettingsSettings                                               (Parm, OutParm, HasGetValueTypeHash)

void UGI_SinglePlayer_C::GetReinforcementSettingsFromClassName(const class FString& EnemyClassName, bool* Success, TSoftClassPtr<class UClass>* Param_Class, struct FSTRUCT_EnemyReinforcementSettings* Settings)
{
	static class UFunction* Func = nullptr;
...
void UGI_SinglePlayer_C::GetReinforceClassNameFromClass(TSoftClassPtr<class UClass> Param_Class, class FString* ClassName)
{
	static class UFunction* Func = nullptr;
...
void UGI_SinglePlayer_C::GetDestructionCodeDigitByIndex(int32 Param_Index, int32* Digit)
{
	static class UFunction* Func = nullptr;
