...
// Parameters:
// class UWIDGET_PlayerHUD_C*              Param_HUDWidget                                        (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UWIDGET_InventoryContextMenu_C::InitializeInventoryContextMenu(class UWIDGET_PlayerHUD_C* Param_HUDWidget)
{
	...
	Parms.Param_HUDWidget = Param_HUDWidget;
