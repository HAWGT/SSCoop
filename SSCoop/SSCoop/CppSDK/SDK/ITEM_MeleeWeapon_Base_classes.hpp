...
class UITEM_MeleeWeapon_Base_C final : public UITEM_WeaponBase_C
{
public:
	...
	uint8                                         Pad_38EE[0x4];                                     // 0x0384(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_38EF[0x5];                                     // 0x0773(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_38F0[0x7];                                     // 0x07F1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	void GetFastAttackMontageIndex(class UAnimMontage* Montage, int32* Param_Index);
