...
public:
	...
	uint8                                         Pad_3A4A[0x3];                                     // 0x0585(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3A4B[0x7];                                     // 0x05C1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	void SetCurrentChargeCount(uint8 Param_Count);
	...
	void ApplyAccuracyChangeAndRecoil(bool Param_HasKickback);
