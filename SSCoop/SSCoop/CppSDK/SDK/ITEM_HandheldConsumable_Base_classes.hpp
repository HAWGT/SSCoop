...
public:
	void ConsumableCountChanged__DelegateSignature(class UITEM_Base_C* HandheldItem, int32 Param_Count);
	void EVENT_OnConsumableBagChanged(class UInventoryBag_C* Param_Bag, int32 Param_SlotIndex);
