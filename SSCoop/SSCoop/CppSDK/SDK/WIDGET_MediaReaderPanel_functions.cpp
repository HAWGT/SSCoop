...
// Parameters:
// class UWIDGET_PlayerHUD_C*              Param_PlayerHUD                                        (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UWIDGET_MediaPanel_C*             Param_MediaPanel                                       (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UWIDGET_MediaReaderPanel_C::InitializeReaderPanel(class UWIDGET_PlayerHUD_C* Param_PlayerHUD, class UWIDGET_MediaPanel_C* Param_MediaPanel)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_MediaPanel = Param_MediaPanel;
...
// Parameters:
// class UITEM_MediaBase_C*                Param_MediaItem                                        (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UWIDGET_MediaReaderPanel_C::SetMediaReaderData(class UITEM_MediaBase_C* Param_MediaItem)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_MediaItem = Param_MediaItem;
