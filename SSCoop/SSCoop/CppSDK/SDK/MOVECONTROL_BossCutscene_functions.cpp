...
void UMOVECONTROL_BossCutscene_C::InitializeMoveControl(class APAWN_Hacker_Simple_C* Param_Player, float GameTime, const struct FSTRUCT_MoveControlParams& InitialControlParams, bool* Result)
{
