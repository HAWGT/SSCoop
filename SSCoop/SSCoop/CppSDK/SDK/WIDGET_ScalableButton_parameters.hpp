...
public:
	...
	uint8                                         Pad_2066[0x3];                                     // 0x0005(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	class FText                                   Param_Caption;                                     // 0x0000(0x0018)(BlueprintVisible, BlueprintReadOnly, Parm)
};
...
static_assert(offsetof(WIDGET_ScalableButton_C_SetCaption, Param_Caption) == 0x000000, "Member 'WIDGET_ScalableButton_C_SetCaption::Param_Caption' has a wrong offset!");
