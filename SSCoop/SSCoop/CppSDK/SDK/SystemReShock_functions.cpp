...
// Parameters:
// struct FColor                           Param_Color                                            (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UGridMeshWidget::SetBorderColor(const struct FColor& Param_Color)
{
	static class UFunction* Func = nullptr;
...
void UGridMeshWidget::SetColor(const struct FColor& Param_Color)
{
	static class UFunction* Func = nullptr;
