...
// float                                   Param_TurboElapsedTime                                 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UHARDWARE_TurboBoots_Base_C::OnTurboBootTick(float DeltaTime, float Param_TurboElapsedTime)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_TurboElapsedTime = Param_TurboElapsedTime;
