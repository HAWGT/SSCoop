...
void UWIDGET_DifficultyHexagonButton_C::OnSelectNewDifficulty__DelegateSignature(int32 Param_IndexInList)
{
...
void UWIDGET_DifficultyHexagonButton_C::SetSelected(bool Param_Selected)
{
	static class UFunction* Func = nullptr;
...
void UWIDGET_DifficultyHexagonButton_C::SetHighlighted(bool Param_Highlighted)
{
	static class UFunction* Func = nullptr;
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// bool                                    Param_Disabled                                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)

void UWIDGET_DifficultyHexagonButton_C::SetDisabled(bool Param_Disabled)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_Disabled = Param_Disabled;
...
void UWIDGET_DifficultyHexagonButton_C::SetHovered(bool Param_Hovered)
{
	static class UFunction* Func = nullptr;
