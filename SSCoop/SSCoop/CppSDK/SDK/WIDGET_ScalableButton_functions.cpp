...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// class FText                             Param_Caption                                          (BlueprintVisible, BlueprintReadOnly, Parm)

void UWIDGET_ScalableButton_C::SetCaption(const class FText& Param_Caption)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_Caption = std::move(Param_Caption);
