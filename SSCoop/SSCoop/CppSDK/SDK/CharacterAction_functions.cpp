...
// float                                   Param_MontageDuration                                  (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UCharacterAction_C::PlayMontage(float PlayRate, float* Param_MontageDuration)
{
	static class UFunction* Func = nullptr;
	...
	if (Param_MontageDuration != nullptr)
		*Param_MontageDuration = Parms.Param_MontageDuration;
}
...
void UCharacterAction_C::ResumeMontage(float PlayRate, float* Param_MontageDuration)
{
	static class UFunction* Func = nullptr;
...
// ENUM_ActionPriority                     Param_Priority                                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UCharacterAction_C::SetMontageWithPriority(class UAnimMontage* Param_Montage, ENUM_ActionPriority Param_Priority)
{
	static class UFunction* Func = nullptr;
