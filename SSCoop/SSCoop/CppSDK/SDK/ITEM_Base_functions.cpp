...
void UITEM_Base_C::CountChanged__DelegateSignature(class UITEM_Base_C* Item, int32 Param_Count)
{
	static class UFunction* Func = nullptr;
...
void UITEM_Base_C::InitializeItem(class UInventoryBag_C* Param_Bag)
{
	static class UFunction* Func = nullptr;
