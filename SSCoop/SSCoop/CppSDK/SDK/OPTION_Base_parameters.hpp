...
static_assert(offsetof(OPTION_Base_C_IsDirty, Param_IsDirty) == 0x000000, "Member 'OPTION_Base_C_IsDirty::Param_IsDirty' has a wrong offset!");
...
static_assert(offsetof(OPTION_Base_C_InitializeMenuListItem, Param_Index) == 0x000008, "Member 'OPTION_Base_C_InitializeMenuListItem::Param_Index' has a wrong offset!");
