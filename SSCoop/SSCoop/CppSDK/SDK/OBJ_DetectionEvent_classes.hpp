...
public:
	...
	uint8                                         Pad_2905[0x3];                                     // 0x0031(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	void InitializeDetectionEvent(class APAWN_SystemShockCharacter_C* Param_DetectedPawn);
	...
	void GetLastSeenTimestamp(float* Param_LastSeenTimestamp);
	void GetLastHeardTimestamp(float* Param_LastHeardTimestamp);
