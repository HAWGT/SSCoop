...
// Parameters:
// bool                                    Param_State                                            (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
// bool                                    Result                                                 (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor)

void AINTERACT_CircuitBreakerLever_C::SetInteractPowered(bool Param_State, bool* Result)
{
	static class UFunction* Func = nullptr;
