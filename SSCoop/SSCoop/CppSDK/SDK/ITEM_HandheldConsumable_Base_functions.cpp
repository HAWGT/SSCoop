...
void UITEM_HandheldConsumable_Base_C::ConsumableCountChanged__DelegateSignature(class UITEM_Base_C* HandheldItem, int32 Param_Count)
{
...
// Parameters:
// class UInventoryBag_C*                  Param_Bag                                              (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// int32                                   Param_SlotIndex                                        (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UITEM_HandheldConsumable_Base_C::EVENT_OnConsumableBagChanged(class UInventoryBag_C* Param_Bag, int32 Param_SlotIndex)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_SlotIndex = Param_SlotIndex;
