...
public:
	...
	uint8                                         Pad_404A[0x7];                                     // 0x0211(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_404B[0x7];                                     // 0x0269(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	void InitializeDismemberedLimb(int32 Param_LowHideMask, int32 Param_HighHideMask, class UDataTable* DismembermentData, class UDataTable* DynaDamageData, class FName Param_LimbRowName, int32 MissingLimbBits, int32 ActivatedDynaDamageBits, TArray<struct FVector4>& BloodData);
	...
	void ForceDismemberLimb(class FName LimbToDismember, class UOBJ_ImpactData_C* Impact, const struct FAttribDamageInstance& Damage, bool Param_DestroyLimb, bool* LegDismembered);
	...
	void GetLimbByIndex(int32 Param_Index, class FName* LimbName);
	...
	void GetLimbIndex(class FName LimbName, int32* Param_Index);
	...
	void GetDynaIndex(class FName DynaElement, int32* Param_Index);
	...
	void GetDynaDamageByIndex(int32 Param_Index, class FName* DynaName);
