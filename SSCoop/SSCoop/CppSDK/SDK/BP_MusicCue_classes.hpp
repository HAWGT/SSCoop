...
public:
	...
	uint8                                         Pad_3406[0x4];                                     // 0x003C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3407[0x3];                                     // 0x009D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3408[0x4];                                     // 0x00DC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	void GetMusicLayerByName(class FName& Param_Name, class UBP_MusicLayer_C** Layer);
	...
	void EVENT_OnQuartzBar(class FName Param_ClockName, EQuartzCommandQuantization QuantizationType, int32 NumBars, int32 Beat, float BeatFraction);
