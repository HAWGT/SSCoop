...
// Parameters:
// class UITEM_Base_C*                     Param_Item                                             (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UWIDGET_InventoryDetails_C*       Param_InventoryDetails                                 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                                    Result                                                 (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor)

void UWIDGET_SubDetails_Weapon_C::InitializeItemDetails(class UITEM_Base_C* Param_Item, class UWIDGET_InventoryDetails_C* Param_InventoryDetails, bool* Result)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_InventoryDetails = Param_InventoryDetails;
