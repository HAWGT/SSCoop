...
public:
	...
	uint8                                         Pad_1DF7[0x7];                                     // 0x0231(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	void InitializeMinigame(class ACON_Hacker_C* Param_PlayerController, class APAWN_Hacker_Simple_C* PlayerPawn, class USceneCaptureComponent2D* Param_SceneCaptureComponent, bool* Result);
	void UpdateMinigame(float DeltaTime, bool* Result);
	void UnloadMinigame(bool* Result);
	void PossessMinigamePawn(class APawn* TargetPawn, class APAWN_Hacker_Simple_C* Param_HackerPawn, class ACON_Hacker_C* Controller, bool* Result);
	void TogglePause();
	void OnGamePaused(class APlayerController* Param_PlayerController);
	void OnGameUnpaused();
