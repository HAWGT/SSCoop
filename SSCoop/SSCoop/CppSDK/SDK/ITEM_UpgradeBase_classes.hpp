...
public:
	...
	uint8                                         Pad_36E2[0x4];                                     // 0x014C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	void GetBestModuleIndexForUpgrade(class UClass* UpgradeClass, int32* Param_Index);
