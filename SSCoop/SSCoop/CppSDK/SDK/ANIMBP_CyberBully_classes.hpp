...
{
public:
	uint8                                         Pad_243A[0x8];                                     // 0x02B8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	void GetStance(ENUM_Emotions* Param_Stance);
	void SetStance(ENUM_Emotions Param_Stance, bool* Result);
