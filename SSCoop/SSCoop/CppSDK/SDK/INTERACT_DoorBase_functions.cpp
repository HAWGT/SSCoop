...
// Parameters:
// bool                                    Result                                                 (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor)
// class FText                             Param_BrokenMessage                                    (Parm, OutParm)

void AINTERACT_DoorBase_C::GetInteractBroken(bool* Result, class FText* Param_BrokenMessage)
{
	static class UFunction* Func = nullptr;
	...
	if (Param_BrokenMessage != nullptr)
		*Param_BrokenMessage = std::move(Parms.Param_BrokenMessage);
}
...
// Parameters:
// bool                                    Result                                                 (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor)
// class FText                             Param_BusyMessage                                      (Parm, OutParm)

void AINTERACT_DoorBase_C::GetInteractBusy(bool* Result, class FText* Param_BusyMessage)
{
	static class UFunction* Func = nullptr;
	...
	if (Param_BusyMessage != nullptr)
		*Param_BusyMessage = std::move(Parms.Param_BusyMessage);
}
