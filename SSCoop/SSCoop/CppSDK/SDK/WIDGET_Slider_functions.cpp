...
void UWIDGET_Slider_C::GetSliderValueFromMousePosition(float* Param_SliderValue)
{
	static class UFunction* Func = nullptr;
...
void UWIDGET_Slider_C::GetSliderPositionFromValue(float Param_SliderValue, struct FVector2D* NewParam)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// int32                                   Param_DiscreteValues                                   (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// class FText                             Param_Postfix                                          (BlueprintVisible, BlueprintReadOnly, Parm)
// int32                                   Param_FractionalDigits                                 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UWIDGET_Slider_C::Set_Instanced_Values(int32 Param_DiscreteValues, float InitialValues, float Param_ValueMin, float Param_ValueMax, const class FText& Param_Postfix, int32 Param_FractionalDigits)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_DiscreteValues = Param_DiscreteValues;
	Parms.InitialValues = InitialValues;
	Parms.Param_ValueMin = Param_ValueMin;
	Parms.Param_ValueMax = Param_ValueMax;
	Parms.Param_Postfix = std::move(Param_Postfix);
	Parms.Param_FractionalDigits = Param_FractionalDigits;
...
void UWIDGET_Slider_C::NormalizedToReal(float Param_SliderValue, float* RealValue) const
{
	static class UFunction* Func = nullptr;
