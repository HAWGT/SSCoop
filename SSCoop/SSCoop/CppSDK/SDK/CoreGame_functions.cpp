...
TArray<class UClass*> UCoreGameFunctionLibrary::GetBlueprintClasses(class UClass* BaseClass, const class FString& Param_Name, const class FString& Folder)
{
	static class UFunction* Func = nullptr;
...
class UObject* UCoreGameFunctionLibrary::GetClassDefaultObject(class UClass* Param_Class)
{
	static class UFunction* Func = nullptr;
...
int64 UCoreGameFunctionLibrary::GetEnumValueByName(class UEnum* Enum, class FName Param_Name)
{
	static class UFunction* Func = nullptr;
...
class UClass* UCoreGameFunctionLibrary::GetSuperClass(class UClass* Param_Class)
{
	static class UFunction* Func = nullptr;
...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// float                                   Param_Smoothing                                        (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UWeightedAverageBase::SetSmoothingFactor(float Param_Smoothing)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_Smoothing = Param_Smoothing;
