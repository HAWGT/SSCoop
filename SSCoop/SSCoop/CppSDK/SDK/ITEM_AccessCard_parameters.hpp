...
public:
	...
	class UClass*                                 Param_AnimInstanceClass;                           // 0x0008(0x0008)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                         Pad_36F8[0x7];                                     // 0x0031(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(ITEM_AccessCard_C_GetDisplayProperties, Param_AnimInstanceClass) == 0x000008, "Member 'ITEM_AccessCard_C_GetDisplayProperties::Param_AnimInstanceClass' has a wrong offset!");
