...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// bool                                    Param_IsDisabled                                       (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)

void UWIDGET_ButtonLegend_Icon_C::SetDisabled(bool Param_IsDisabled)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_IsDisabled = Param_IsDisabled;
