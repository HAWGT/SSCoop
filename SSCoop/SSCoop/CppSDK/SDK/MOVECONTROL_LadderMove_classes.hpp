...
{
public:
	uint8                                         Pad_2035[0x4];                                     // 0x0094(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2036[0x3];                                     // 0x00C5(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	void InitializeMoveControl(class APAWN_Hacker_Simple_C* Param_Player, float GameTime, const struct FSTRUCT_MoveControlParams& InitialControlParams, bool* Result);
