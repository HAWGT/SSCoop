...
class AELEVATOR_Base_C final : public AINTERACT_Base_C
{
public:
	...
	uint8                                         Pad_2CF9[0x4];                                     // 0x03CC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2CFA[0x2];                                     // 0x03FA(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2CFB[0x6];                                     // 0x04AA(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2CFC[0x2];                                     // 0x04C2(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2CFD[0x4];                                     // 0x04CC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2CFE[0x3];                                     // 0x0595(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2CFF[0x4];                                     // 0x062C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	void GetTargetLevelName(class UPrimitiveComponent* CursorPrimitive, class FName* Param_TargetLevel);
	void GetDirectionToTargetLevelFromSource(class FName SourceLevel, class FName Param_TargetLevel, ENUM_UpDown* DirectionToTarget);
	void GetTargetLevel(class FName* Param_TargetLevel);
	...
	void GetMoveDirectionVector(class FName Param_TargetLevel, struct FVector* Direction);
